    ...
    return (
        <div className={cn("relative", disabled && "opacity-50 pointer-events-none", className)}>
            ...
            >
                ...
                />
                {hasFile ? (
                    <div className="absolute inset-0 w-full h-full rounded-2xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="flex flex-col items-center justify-center gap-4 p-6 text-center">
                        ...
                        <div className="space-y-1">
                            <p className="text-sm font-semibold text-foreground">{editorContent.upload.videoLabel}</p>
                            <p className="text-xs text-muted-foreground">
                                {isDragActive ? editorContent.upload.releaseToDrop : editorContent.upload.videoFormats}
                            </p>
                        </div>
                    </div>
                )}

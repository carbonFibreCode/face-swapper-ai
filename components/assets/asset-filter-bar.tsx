            ...
            <div className="flex-1 overflow-x-auto">
                 <AnimatedTabs
                    ...
                    items={FILTER_OPTIONS.map((option) => {
                        ...
                        const count = option.value === 'all' ? counts.total : option.value === 'images' ? counts.images : counts.videos;
                        ...
                        return {
                            ...
                            label: (
                                <>
                                    ...
                                    <span className={`px-2 py-0.5 rounded-md text-xs font-semibold transition-colors duration-300 ${isActive ? 'bg-primary-foreground/25 text-primary-foreground' : 'bg-muted/80 text-muted-foreground'}`}>
                                        {count}
                                    </span>
                                </>
                            ),

        ...
        >
            <div className="glass-card rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="relative aspect-[4/3] overflow-hidden bg-muted/30">
                    ...
                    { }
                    <div
                        className={`absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex items-end justify-center pb-4 gap-2 transition-opacity duration-200 z-20 ${isHovered ? 'opacity-100' : 'opacity-0'
                            }`}
                    >
                        <button
                            onClick={(e) => {

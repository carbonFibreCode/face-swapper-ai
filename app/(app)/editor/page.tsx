...
import {
    ...
    VideoUploadBox,
    FaceUploadBox,
} from "@/components/editor/media-upload-box";
                            ...
                            >
                                {isProcessing ? (
                                    <>
                                        ...
                                        {isUploading ? commonContent.actions.uploading : commonContent.actions.processing}
                                    </>
                                ) : (
                                    <>
                                ...
                                <div className="flex flex-col items-center gap-6 p-8 rounded-2xl bg-background/90 shadow-2xl border">
                                    ...
                                    <div className="space-y-2 text-center">
                                        <h3 className="text-xl font-semibold tracking-tight">
                                            {isUploading ? editorContent.status.preparing : editorContent.status.processing}
                                        </h3>
